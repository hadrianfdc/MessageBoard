 ...
 */
	Configure::write('Security.salt', '5KZPUWMDO4EU9xNTA5eb4ZLeSEGLpeO3O40fUsOv');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '892973081932988479013488425581');
 ...
 */
 ...
 Cache::config('_cake_core_', array(
    'engine' => 'File', // You can also use 'Apc', 'Memcache', 'Redis', etc.
    'prefix' => 'cake_core_',
